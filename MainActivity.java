...
public class MainActivity extends AppCompatActivity {
    int starttime =0; int stoptime = 0;
    int forewardtime = 5000; int backwardtime = 5000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this,R.raw.experience); mediaPlayernew = MediaPlayer.create(this,R.raw.experience); TextView songtitle = findViewById(R.id.textView);

        songtitle.setText("Experience");


        Button play = findViewById(R.id.Play); play.setOnClickListener(new View.OnClickListener(){
            @Override
